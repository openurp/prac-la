...
[@b.toolbar title="新增/修改项目单位要求"]bar.addBack();[/@]
  [@b.form theme="list" action=b.rest.save(laOption)]
    ...
    [@b.textfield name="laOption.capacity" label="报名人数上限" value="${laOption.capacity}" required="true" style="width:50px;"/]
    [@b.textfield name="laOption.enrollLimit" label="录取人数上限" value="${laOption.enrollLimit}" required="true" style="width:50px;"/]
    [@b.formfoot]
