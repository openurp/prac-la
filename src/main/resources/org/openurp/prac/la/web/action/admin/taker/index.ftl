...
[@base.semester_bar name="semester.id" value=currentSemester/]
   <div class="search-container">
    ...
    [@b.form name="laTakerSearchForm" action="!search" target="laTakerlist" title="ui.searchForm" theme="search"]
      ...
      [@b.textfield name="laTaker.volunteer.std.code" label="学号"/]
      [@b.textfield name="laTaker.volunteer.std.name" label="姓名"/]
      ...
      <input type="hidden" name="orderBy" value="laTaker.volunteer.std.code"/>
    [/@]
     </div>
